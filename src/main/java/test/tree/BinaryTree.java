...
public class BinaryTree {
    ...
    private BinaryTreeNode findInBTRec(BinaryTreeNode node, int nodeData) {
        ...
        return findInBTRec(node.right, nodeData);
    }
     ...
     * @param node
     */
    public static void walkTree(BinaryTreeNode node) {
    ...
    public static void walkTreeRec(BinaryTreeNode node) {
        if (node == null) {
            return;
        }

        walkTreeRec(node.left);
        System.out.println(node.data);
        walkTreeRec(node.right);
    }
}
